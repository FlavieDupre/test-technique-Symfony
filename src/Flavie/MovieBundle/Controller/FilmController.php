...
use Flavie\MovieBundle\Entity\Film;
...
class FilmController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $films = $em->getRepository('FlavieMovieBundle:Film')->findAll();
    ...
    {
        $film = new Film();
        $form = $this->createForm('Flavie\MovieBundle\Form\FilmType', $film);
    ...
    {
        $deleteForm = $this->createDeleteForm($film);
        $editForm = $this->createForm('Flavie\MovieBundle\Form\FilmType', $film);
