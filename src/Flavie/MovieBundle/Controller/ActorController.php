...
use Flavie\MovieBundle\Entity\Actor;
...
class ActorController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $actors = $em->getRepository('FlavieMovieBundle:Actor')->findAll();
    ...
    {
        $actor = new Actor();
        $form = $this->createForm('Flavie\MovieBundle\Form\ActorType', $actor);
    ...
    {
        $deleteForm = $this->createDeleteForm($actor);
        $editForm = $this->createForm('Flavie\MovieBundle\Form\ActorType', $actor);
